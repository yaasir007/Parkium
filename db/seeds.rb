...
parking = Parking.create(name: "CarPark 1" , address: "Port-Louis" , description: "Fully Secure Parking Area with Cameras and Guards" , number_of_slots: 100 , fees: 100  ,available_slots: 100 ,user_id: 1 )
...
parking1 = Parking.create(name: "CarPark 2" , address: "Rose-Hill" , description: "Covered Parking Area with Cameras" , number_of_slots: 50 , fees: 70  ,available_slots: 50 ,user_id: 1 )
...
parking2 = Parking.create(name: "CarPark 3" , address: "Grand-Port" , description: "Fully secure Parking Area with Cameras and Guards" , number_of_slots: 35 , fees: 50 ,available_slots: 35 ,user_id: 1 )
...
parking3 = Parking.create(name: "CarPark 4" , address: "Grand Bay" , description: "Covered Parking Space with Guards and Security System" , number_of_slots: 45 , fees: 80  ,available_slots: 45 ,user_id: 1 )
...
parking4 = Parking.create(name: "CarPark 5" , address: "Rose-Belle", description: "Safe & Secure Parking Area under Camera Surveillance" , number_of_slots: 35 , fees: 50  ,available_slots: 35 ,user_id: 1 )
...
parking5 = Parking.create(name: "CarPark 6" , address: "Belle-Rose" , description: "Parking Area with Cameras and Guards" , number_of_slots: 55 , fees: 60  ,available_slots: 55 ,user_id: 1 )
...
parking6 = Parking.create(name: "CarPark 7" , address: "Ebene" , description: "Parking Slots with latest Surveillance Systems" , number_of_slots: 110 , fees:120  ,available_slots: 110 ,user_id: 1)
...
parking7 = Parking.create(name: "CarPark 8" , address: "Phoenix", description: "Fully secure Parking Area with Cameras and Security Personals" , number_of_slots: 55 , fees: 85  ,available_slots: 55 ,user_id: 1 )
...
parking8 = Parking.create(name: "CarPark 9" , address: "Bagatelle", description: "Parking Spaces with Cameras and Guards" , number_of_slots: 95 , fees: 90  ,available_slots: 95 ,user_id: 1 )
...
parking9 = Parking.create(name: "CarPark 10" , address: "Phoenix", description: "Fully secure Parking Area with Cameras and Guards" , number_of_slots: 45 , fees: 65  ,available_slots: 45 ,user_id: 1 )
...
parking10 = Parking.create(name: "CarPark 11" , address: "La Croissette", description: "Fully secure Parking Area with Cameras and Guards" , number_of_slots: 75 , fees: 80  ,available_slots: 75 ,user_id: 1 )
