...
parking = Parking.create(name: "i-Park" , address: "Port-Louis, Mauritius" , description: "Fully Secure Parking Area with Cameras and Guards" , number_of_slots: 100 , fees: 100  ,available_slots: 100 ,user_id: 1 )
...
parking1 = Parking.create(name: "Gallery Evershine Parking" , address: "Tamarin, Mauritius" , description: "Covered Parking Area with Cameras" , number_of_slots: 50 , fees: 70  ,available_slots: 50 ,user_id: 1 )
...
parking2 = Parking.create(name: "ParkMe" , address: "Grand-Port, Mauritius" , description: "Fully secure Parking Area with Cameras and Guards" , number_of_slots: 35 , fees: 50 ,available_slots: 35 ,user_id: 1 )
...
parking3 = Parking.create(name: "La Croisette Parking" , address: "Grand-Baie, Mauritius" , description: "Covered Parking Space with Guards and Security System" , number_of_slots: 45 , fees: 80  ,available_slots: 45 ,user_id: 1 )
...
parking4 = Parking.create(name: "Safe Parking" , address: "Rose-Belle, Mauritius", description: "Safe & Secure Parking Area under Camera Surveillance" , number_of_slots: 35 , fees: 50  ,available_slots: 35 ,user_id: 1 )
...
parking5 = Parking.create(name: "Les Kocottes" , address: "St-Pierre, Mauritius" , description: "Parking Area with Cameras and Guards" , number_of_slots: 55 , fees: 60  ,available_slots: 55 ,user_id: 1 )
...
parking7 = Parking.create(name: "The Parking Spot" , address: "Phoenix, Mauritius", description: "Fully secure Parking Area with Cameras and Security Personals" , number_of_slots: 55 , fees: 85  ,available_slots: 55 ,user_id: 1 )
...
parking8 = Parking.create(name: "Park & Shop" , address: "Bagatelle, Mauritius", description: "Parking Spaces with Cameras and Guards" , number_of_slots: 95 , fees: 90  ,available_slots: 95 ,user_id: 1 )
...
parking9 = Parking.create(name: "Spot Hero" , address: "Grand Sable, Mauritius", description: "Fully secure Parking Area with Cameras and Guards" , number_of_slots: 45 , fees: 65  ,available_slots: 45 ,user_id: 1 )
...
parking10 = Parking.create(name: "Best Parking" , address: "La Croissette, Mauritius", description: "Fully secure Parking Area with Cameras and Guards" , number_of_slots: 75 , fees: 80  ,available_slots: 75 ,user_id: 1 )
